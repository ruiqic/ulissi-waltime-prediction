...
def get_features_noneighbors(atoms):
    """
    Get training features from a given atoms object, this method works for 
    objects without a tagged adsorbate.
    
    Parameters:
        atoms (ase.Atoms): atoms object.
        
    Returns:
        features (list): 8 features in order 
            [cell volume, 
             number of primitive cells in unit cell,
             surface area,
             number of atoms
